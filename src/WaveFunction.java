public class WaveFunction 
{
	...
	{
		rHamiltonian[0] = 0;
		rHamiltonian[Params.N + 1] = 0;
		iHamiltonian[0] = 0;
		iHamiltonian[Params.N + 1] = 0; 
		rHalfHamiltonian[0] = 0;
		rHalfHamiltonian[Params.N + 1] = 0; //this six lines are from (31) border conditions
		...
		for (int k=1; k<Params.N; k++)
		{
			...
			rHalfHamiltonian[k] = -0.5*(rValues[k+1]+rValues[k-1]-2*rValues[k])/(dx*dx)
					+ Params.kappa*(points[k]-0.5)*rValues[k]*Math.sin(Params.tau*Params.omega+Params.dTau/2); //(30)
		}
	}
